...
format: 
  revealjs: 
    ...
    linestretch: 1.1
    margin: 0.1
    footer: "Summary of R software for Symbolic Data Analysis"
    slideNumber: true
...
by Stamey et al. (1989) that examined the correlation between the level of prostate specific antigen (PSA) and a number of clinical measures, in 97
...
`age`, log of benign prostatic hyperplasia amount `lbph`, seminal vesicle invasion
`svi`, log of capsular penetration `lcp`, Gleason score `gleason`, and
