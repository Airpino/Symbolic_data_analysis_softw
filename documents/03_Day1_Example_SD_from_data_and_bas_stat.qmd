...
format: 
  revealjs: 
    ...
    fontsize: 2em
    linestretch: 1.1
    footer: "Symbolic Data from classical data and basic stats, ESTP Cologne 14-16 May 2024"
    slideNumber: true
filters:
  - "parse-latex.lua"
...
```{r center_raddi_transform, collapse=TRUE,echo=T}
get.histo(mydist)
...
data2hist( data,
           algo = "histogram",
           type = "combined",
           qua = 10, breaks = numeric(0), epsilon = 0.01
)
```

::: columns
::: {.column style="font-size: 0.65em; width: 100%;"}
| __Arguments__ | Description |
|---|------------------------|
...
_Output_ : A distributionH object, i.e. a distribution.
